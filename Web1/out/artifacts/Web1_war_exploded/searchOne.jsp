...
<table border="2px" align="center">
    ...
    %>
    <tr>
        <td><%=tiArray.get(i).getId() %></td><td><a href="searchOne2.jsp?name=<%=tiArray.get(i).getName()%>"><%=tiArray.get(i).getName() %></></td><td><%=tiArray.get(i).getTel() %></td><td><%=tiArray.get(i).getDate() %></td>
    </tr>
    <%
