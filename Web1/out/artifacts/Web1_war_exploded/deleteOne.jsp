...
<table border="2px" align="center">
    ...
    %>
    <tr>
        <td><a href="deleteOne.do?id=<%=tiArray.get(i).getId()%>"><%=tiArray.get(i).getId() %></a></td><td><%=tiArray.get(i).getName() %></td><td><%=tiArray.get(i).getTel() %></td><td><%=tiArray.get(i).getDate() %></td>
    </tr>
    <%
