...
/*
    ...
    //제목,작성자,내용만 뜨게
    public boolean update_all(int bunho,String snscontent) throws SQLException
    {
        String sql = "update mvcsnsboard set snscontent=? where bunho=?";
        pstmt = conn.prepareStatement(sql);

            pstmt.setString(1,snscontent);
    ...
    public boolean insert_sns(String snsjemok,String snswriter,String snscontent) throws SQLException
    {
        ...
        //insert into mvcsnsboard values(mvcsnsboard_sequence1.NEXTVAL,'ee','ff','gg',mvcsnsboard_sequence1.CURRVAL,0,0);
