...
<body>
<form action="snsAllview.do" method="get">
    <table border="2px" align="center">
        <tr>
            <td conspan="7" align="center"><input type="submit" value="확인"></td>
        </tr>
<tr>
    <td conspan="7" align="center">전체</td>
</tr>
        <tr>
        ...
        %>
        <tr>
            <td><%=sa.get(i).getBunho() %></td><td><%=sa.get(i).getSnsjemok() %></td><td><%=sa.get(i).getSnswriter() %></td><td><%=sa.get(i).getSnscontent() %></td><td><%=sa.get(i).getBasebun() %></td><td><%=sa.get(i).getDaetbun() %></td><td><%=sa.get(i).getDaetdaetbun()%></td>
        </tr>
        <%
