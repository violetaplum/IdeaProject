...
<body>
    ...
    <table border="2px" align="center">
        ...
        %>
        <tr>
            <td><%=sa.get(i).getBunho() %></td><td><%=sa.get(i).getJemok() %></td><td><%=sa.get(i).getWriter() %></td><td><%=sa.get(i).getContent() %></td><td><%=sa.get(i).getBasebun() %></td><td><%=sa.get(i).getDaetbun() %></td><td><%=sa.get(i).getDaetdaetbun()%></td>
        </tr>
        <%
